...
class menuEditor {
    ...
    static function getParam($index){
        ...
        if ($index>=0){
            ...
            return array('text'=>'','func'=>'','icon'=>'','scut'=>'','name'=>'');
    }
    ...
    static function setParam($index, $params){
        ...
        $item.= $params['func'] .','. $params['icon'] .','. $params['scut'] .','. $params['name'];
        $item.=']';
    ...
    static function getParams(){
        ...
        $result['icon'] = val('edt_menuEditor->e_icon');
...
class ev_edt_menuEditor_btn_insert {
    ...
    static function onClick($self){
        ...
        $index = menuEditor::insert( c('edt_menuEditor->tree')->absIndex, array('text'=>t('Menu item %s', count(menuEditor::getResult())+1)) );
        menuEditor::updateTree();
